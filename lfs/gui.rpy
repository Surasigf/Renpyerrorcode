...
define gui.interface_text_color = u'#0000ff'


## Шрифты и их размеры #########################################################

## Шрифт, используемый внутриигровым текстом.
define gui.text_font = "appetite-italic.ttf"

## Шрифт, используемый именами персонажей.
define gui.name_text_font = "sunday.ttf"

## Шрифт, используемый текстом вне игры.
define gui.interface_text_font = "Capture.ttf"
...
define gui.main_menu_background = Movie(play="images/Video.ogv",loop=True,size=(1920,1080))
