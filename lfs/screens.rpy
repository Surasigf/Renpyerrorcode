...
screen main_menu():
    ...
    imagemap:
        ...
        hotspot(63, 187, 345, 90) action Start()
        hotspot(64, 349, 380, 90) action ShowMenu("load")
        hotspot(52, 493, 380, 80) action ShowMenu("preferences")
        hotspot(69, 627, 360, 80) action ShowMenu("about")
        hotspot(84, 759, 355, 80) action ShowMenu("help")
        hotspot(36, 952, 350, 80) action Quit(confirm=True)
